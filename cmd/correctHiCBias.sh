...
"${ETSCRIPT}/estimate_intra_read_pairs_sig.pl" "${GENOME_CHRM}/${RE}_fragment_GC_MAPP_LEN.bed" chr*_${THRE}_reads_interaction.txt "intra_Fgc_binned.txt" "intra_L_binned.txt"
